...
public class ChipsInputLayout extends MaxHeightScrollView implements FilterableChipsAdapter.OnFilteredChipClickListener
{
  ...
  public ChipsInputLayout(Context c, AttributeSet attrs, int defStyleAttr)
  {
    ...
    mChipsAdapter = new ChipsAdapter(mDataSource, getChipsInput(), mOptions);
  ...
  @Override public void onFilteredChipClick(Chip chip)
  {
  ...
  public void setInputTextColor(ColorStateList textColor)
  {
    ...
    if (mChipsInput != null)
    { // Can be null because its lazy loaded
  ...
  public ChipsEditText getChipsInput()
  {
    if (mChipsInput == null)
    {
  ...
  public FilterableRecyclerView getFilteredRecycler()
  {
    loadFilterableRecycler();
